...
La última, pero no por ello menos importante fase del proyecto debe estar finalizada el día de la entrega, que es el NI IDEEAAAAAAAAA :DDDDD %TODO PONERLA
...
Todo el proyecto ha sido desarrollado en un ordenador portátil personal. Las especificaciones hardware de dicho ordenador se pueden comprobar en la tabla \ref{tabla:especificaciones-PC}.
\begin{table}[ht]
    \centering
    \begin{tabular}{ll}
    \hline
