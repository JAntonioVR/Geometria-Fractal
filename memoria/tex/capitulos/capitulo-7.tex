...
\begin{figure}[ht]
    \centering
    \begin{tabular}{ccc}
      \includegraphics[scale=0.17]{img/C7/solo-ambiental.png} &   \includegraphics[scale=0.17]{img/C7/solo-difusa.png} &   \includegraphics[scale=0.17]{img/C7/solo-especular.png} \\
...
Y ahora observemos una imagen en la que se aprecian las tres componentes a la vez: la imagen \ref{fig:todas-componentes}. En las esferas predomina el verde, pero se aprecian brillos azules y sombras rojas, pudiendo apreciar perfectamente qué papel desarrolla cada componente del modelo.

\begin{figure} [ht]
    \centering
    \includegraphics[scale = 0.35]{img/C7/todas-componentes.png}
