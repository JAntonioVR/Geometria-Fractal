...
$$
\dim_H(A)\leq\dim_{\inf} (A) \leq \dim_{\sup} (A),
$$
...
Por otro lado, si nos restringimos a conjuntos totalmente autosimilares, existe un resultado que relaciona la dimensión de Hausdorff y la dimensión por cajas para conjuntos totalmente autosimilares: el teorema de Moran \cite{Moran}. Este resultado nos asegura que en estos casos la dimensión por cajas y la dimensión de Hausdorff coinciden siempre que el conjunto sea autosimilar.

En conclusión, para un conjunto genérico cualquiera $A\subseteq\R^n$, se tiene que:

$$
\dim_T(A)\leq\dim_H(A)\leq\dim_{\inf}(A)\leq\dim_{\sup}(A)\leq n
$$
