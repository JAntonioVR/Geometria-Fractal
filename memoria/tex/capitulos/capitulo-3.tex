...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=6cm]{./img/C3/mandelbrot-intro.png} &   \includegraphics[width=6cm]{./img/C3/detalle-Mandelbrot.png} \\
...
Por ejemplo, si queremos representar en \textit{Mathematica} el conjunto de la figura \ref{fig:julia-intro} (a), que era $\mathcal{J}_{-0.12+0.75i}$ utilizaríamos el código situado debajo del algoritmo \ref{alg:Julia}.
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[scale=0.45]{./img/C3/julia-explicado-1.png} &   \includegraphics[scale=0.45]{./img/C3/julia-explicado-2.png} \\
...
Por sí solo, Mathematica incluye una función \verb|JuliaSetPlot[c]| que muestra una imagen del conjunto $\mathcal{J}_c$. Esta función permite modificar los mismos parámetros que el método que acabamos de programar por nuestra cuenta\footnote{Consúltese la documentación oficial de esta función en \url{https://reference.wolfram.com/language/ref/JuliaSetPlot.html?q=JuliaSetPlot} si se desea informar detalladamente de los parámetros modificables.}, véanse las imágenes \ref{fig:julia-set-plot}.
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=6cm]{./img/C3/julia-autosimilar-1.png} &   \includegraphics[width=6cm]{./img/C3/julia-autosimilar-2.png} \\
  (a) $[-0.2,1.5]\times[-1.2,0.5]$ & (b) $[0.6,1.4]\times[-0.9,-0.1]$ \\[6pt]
  \end{tabular}
  
  \centering\begin{tabular}{c}
    \includegraphics[width=6.5cm]{./img/C3/julia-autosimilar-3.png} \\
    (c) $[1.05,1.35]\times[-0.65,-0.35]$ \\[6pt]
  \end{tabular}
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=7cm]{./img/C3/julia-autosimilar-4.png} &   \includegraphics[width=7cm]{./img/C3/julia-autosimilar-5.png} \\
  (a) $\mathcal{J}_{0.33-0.41 i}$ en $[-1,-0.3]\times[-1.1,-0.4]$ & (b) $\mathcal{J}_{0.48-0.13 i}$ en $[-0.6,-0.1]\times[0.25,0.75]$ \\[6pt]
  \includegraphics[width=7cm]{./img/C3/julia-autosimilar-6.png} &   \includegraphics[width=7cm]{./img/C3/julia-autosimilar-7.png} \\
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-1.png} &   \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-2.png} \\
  (a) $[-1,-0.5]\times[0,0.5]$ & (b) $[-1.5,-1.2]\times[-0.15,0.15]$ \\[6pt]
  \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-3.png} &   \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-4.png} \\
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-5.png} &   \includegraphics[width=7cm]{./img/C3/mandelbrot-autosimilar-6.png} \\
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[height=6cm]{./img/C3/julia-generalizado-2.png} &   \includegraphics[height=6cm]{./img/C3/julia-generalizado-3.png} \\
  (a) $z^2-0.55+0.48i$ & (b) $z^3-0.55+0.48i$ \\[6pt]
  \includegraphics[height=6cm]{./img/C3/julia-generalizado-4.png} &   \includegraphics[height=6cm]{./img/C3/julia-generalizado-5.png} \\
