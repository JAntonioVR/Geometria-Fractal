...
\begin{figure}[ht]
  \begin{tabular}{ccc}
    \includegraphics[width=4.5cm]{./img/C3/julia-autosimilar-1.png} &   \includegraphics[width=4.5cm]{./img/C3/julia-autosimilar-2.png} &   \includegraphics[width=4.5cm]{./img/C3/julia-autosimilar-3.png} \\
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=5cm]{./img/C3/julia-autosimilar-4.png} &   \includegraphics[width=5cm]{./img/C3/julia-autosimilar-5.png} \\
  (a) $\mathcal{J}_{0.33-0.41 i}$ en $[-1,-0.3]\times[-1.1,-0.4]$ & (b) $\mathcal{J}_{0.48-0.13 i}$ en $[-0.6,-0.1]\times[0.25,0.75]$ \\[6pt]
  \includegraphics[width=5cm]{./img/C3/julia-autosimilar-6.png} &   \includegraphics[width=5cm]{./img/C3/julia-autosimilar-7.png} \\
...
\begin{figure}[ht]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=5cm]{./img/C3/mandelbrot-autosimilar-1.png} &   \includegraphics[width=5cm]{./img/C3/mandelbrot-autosimilar-2.png} \\
  (a) $[-1,-0.5]\times[0,0.5]$ & (b) $[-1.5,-1.2]\times[-0.15,0.15]$ \\[6pt]
  \includegraphics[width=5cm]{./img/C3/mandelbrot-autosimilar-3.png} &   \includegraphics[width=5cm]{./img/C3/mandelbrot-autosimilar-4.png} \\
