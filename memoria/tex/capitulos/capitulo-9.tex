...
void iterate_julia(inout vec4 q, inout float dq, vec4 c) {
  for(int i = 0; i < 50; i++) {   // 50 son suficientes
    ...
    if(dot(q, q) > 64.0) break;    // |q| es suficientemente grande
  }
}
\end{lstlisting}
