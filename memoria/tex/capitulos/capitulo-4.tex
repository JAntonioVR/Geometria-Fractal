...
\begin{table}
    ...
    1 & 1 & 1 & 0 & 0 & 0 & 0 \\ \hline
    2 & $\dfrac{1}{\sqrt 2}$ & $\dfrac{1}{\sqrt 2}$ & $\dfrac{\pi}{4}$ & $\dfrac{\pi}{4}$ & 0 & 1 \\ \hline
    3 & $\dfrac{1}{\sqrt 2}$ & $\dfrac{1}{\sqrt 2}$ & $-\dfrac{\pi}{4}$ & $-\dfrac{\pi}{4}$ & $\dfrac 1 2$ &  $\dfrac 3 2$ \\ \hline
    \end{tabular}
...
\begin{table}
    ...
    \begin{tabular}{c|cccccc} \hline
        $w$ & $r$ & $s$ & $\alpha$ & $\beta$ & $e$ & $f$ \\ \hline\hline
    1 & 0.85 & 0.85 & $-\dfrac{\pi}{72}$ & $-\dfrac{\pi}{72}$ & 0 & 1.6 \\ \hline
    2 & 0.3 & 0.34 & $\dfrac{49 \pi}{180}$ & $\dfrac{49 \pi}{180}$ & 0 & 1.6 \\ \hline
    3 & 0.3 & 0.34 & $\dfrac{2 \pi}{3}$ & $\dfrac{2 \pi}{3}$ & 0 & 0.44 \\ \hline
