...
\begin{figure}[ht]
    \centering
    \begin{tabular}{cc}
      \includegraphics[width=6.5cm]{img/C8/julia-1.png} &     \includegraphics[width=6.5cm]{img/C8/julia-2.png} \\
    (a) $c=-0.12+0.75 i$ & (b) $c=0.3+1.09j+0.3k$ \\[6pt]
    \includegraphics[width=6.5cm]{img/C8/julia-3.png} &     \includegraphics[width=6.5cm]{img/C8/julia-4.png} \\
...
\begin{figure}[ht]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=6.5cm]{img/C8/mandelbrot-2.png} &
      \includegraphics[width=6.5cm]{img/C8/mandelbrot-1.png} \\    
    \includegraphics[width=6.5cm]{img/C8/mandelbrot-3.png} &     \includegraphics[width=6.5cm]{img/C8/mandelbrot-4.png} \\
    \end{tabular}
...
\begin{figure}[ht]
    \centering
    \begin{tabular}{cc}
        \includegraphics[width=6.5cm]{img/C8/mandelbub-1.png} &
      \includegraphics[width=6.5cm]{img/C8/mandelbub-2.png} \\    
    \includegraphics[width=6.5cm]{img/C8/mandelbub-3.png} &     \includegraphics[width=6.5cm]{img/C8/mandelbub-4.png} \\
    \end{tabular}
