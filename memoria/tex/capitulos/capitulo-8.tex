...
Previo a describir en pseudocódigo el algoritmo, necesitamos fijar algunas constantes que sirven como parámetro al algoritmo. Estas constantes son:
\begin{itemize}
...
\end{itemize}
Por tanto, el algoritmo, si consideramos un conjunto de $objetos$ y un rayo $R(t)=p_0 + \vec v t$, se describiría como indica el algoritmo \ref{alg:Sphere-Tracing}.
