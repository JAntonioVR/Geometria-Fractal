...
%Una vez tenemos claro el procedimiento necesario para calcular esta distancia, la implementación es bastante sencilla. Basta con programar funciones que calculen la SDF y sustituir las llamadas a \verb|get_dist_sphere| por una llamada a dicha función.