...
En la imagen \ref{fig:UML} podemos ver un diagrama de clases del código recién explicado. Si se desea ver en mayor detalle en \href{https://github.com/JAntonioVR/Geometria-Fractal/blob/main/memoria/img/UML.png}{\textcolor{blue}{este enlace}}\footnote{Disponible en la URL \url{https://github.com/JAntonioVR/Geometria-Fractal/blob/main/memoria/img/UML.png}.} puede encontrar el archivo en formato `png'.
