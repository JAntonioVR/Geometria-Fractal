...
python http.server 8000 # Si se dispone de Python3 (recomendado)
  ...
  Por último, en \href{https://nodejs.org/en/knowledge/HTTP/servers/how-to-create-a-HTTP-server/}{\textcolor{blue}{este enlace}}\footnote{https://nodejs.org/en/knowledge/HTTP/servers/how-to-create-a-HTTP-server/} se explica la posibilidad de crear un servidor web utilizando \texttt{node.js}.
