...
Thanks to IFS we can also calculate so easily the box counting dimension of self-similar sets. We explain this relation between these two concepts and give some examples of this calculation.
